    ...
    <div>
        <div class="p-2">
            <FormKit @submit="upsertQuartier" type="form" v-model="quartier" :config="{
                ...
                <FormKit name="id_maison" label="Maison" type="select" :options="optionsMaison" />
                <FormKit name="nom_quartier" label="Quartier" />
                <FormKit name="id_commune" label="Ville" type="select" :options="optionsCommune" />
